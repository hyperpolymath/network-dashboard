...
git clone https://github.com/hyperpolymath/network-dashboard.git cd
network-dashboard
...
toolbox create network-dashboard-dev toolbox enter network-dashboard-dev
...
network-dashboard/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
