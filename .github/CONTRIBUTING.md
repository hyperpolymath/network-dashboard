...
# Contributing — network-dashboard

## Audience

Developers working **on** `network-dashboard`. For consumers (people
...
``` bash
git clone git@github.com:hyperpolymath/network-dashboard.git
...
- Bugs in `network-dashboard`: file at
  `hyperpolymath/network-dashboard/issues`.
